        ...
        <div className="max-w-lg space-y-6 text-center md:text-left">
          ...
          <div className="flex justify-center md:justify-start gap-4">
            <a
              ...
              className="bg-primary-900 text-white px-6 py-3 rounded-md shadow-md hover:bg-primary-800 transition"
            >
              {msgs.auth.registerCompany}
            </a>
            <a
              href="/auth/register/student"
              className="border border-primary-900 px-6 py-3 rounded-md text-primary-900 hover:bg-primary-50 transition"
            >
