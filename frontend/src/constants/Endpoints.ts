...
export const ENDPOINTS = {
  ...
  PROFILE_MISSING_FIELDS: `/${AUTH}/profile/missing/`,
  COMPANY_PROFILE_COMPLETE: `/${AUTH}/${REGISTER}/company/complete/`,
  GOOGLE_LOGIN: `/${AUTH}/google/`,
  GOOGLE_COMPANY_REGISTER: `/${AUTH}/${REGISTER}/company/google/`,
  ...
  DOCUMENTS_APPROVED: (token: number) => `/documents/${token}/approve-company/`,
  DOCUMENTS_REJECTED: (token: number) => `/documents/${token}/reject-company/`,
  DOCUMENTS_WITH_URL: (token: number) => `${BASE_URL}/documents/${token}/upload/`,
